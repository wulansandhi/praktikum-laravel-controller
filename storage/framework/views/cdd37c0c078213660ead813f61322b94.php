                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control<?php echo e($errors->has('firstName') ? ' is-invalid' : ''); ?> "
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Last
                                Name</label>
                            <input class="form-control<?php echo e($errors->has('lastName') ? ' is-invalid' : ''); ?>"
...
<?php /**PATH E:\laravelController\resources\views/employee/create.blade.php ENDPATH**/ ?>